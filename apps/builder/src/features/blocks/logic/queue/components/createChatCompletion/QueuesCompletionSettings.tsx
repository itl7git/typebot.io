...
import { QueuesCompletionMessageItem } from './QueuesCompletionMessageItem'
import {
  Accordion,
  AccordionButton,
  AccordionIcon,
...
import { QueuesCompletionResponseItem } from './QueuesCompletionResponseItem'
...
export const QueuesCompletionSettings = ({
  options,
  onOptionsChange,
}: Props) => {
          ...
          <Accordion allowMultiple>
            <AccordionItem>
              ...
              <AccordionPanel pt="4">
                ...
                >
                  {(props) => <QueuesCompletionMessageItem {...props} />}
                </TableList>
              </AccordionPanel>
            </AccordionItem>
            <AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pt="4">
                <TableList
                  ...
                  hasDefaultItem
                >
                  {(props) => <QueuesCompletionResponseItem {...props} />}
                </TableList>
              </AccordionPanel>
            </AccordionItem>
          </Accordion>
